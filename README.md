...
<body>
    ...
    <footer>The Webpage was developed by Bharath.V
    </footer>
...
<style>
    footer{
        font-size: 30px;
        text-align: center;
        background-color: rgb(36, 196, 21);
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="h2 bg-light" style="height:850px;">
                CREATION:</br>
            ...
            <footer>The Webpage was developed by Bharath.V </footer>
        </body>
        <style>
            footer{
                font-size: 30px;
                text-align: center;
                background-color: rgb(21, 196, 44);
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-info bg-gradient"><a href="/static/admin.html">ADMIN</a></div>
            <div class="col-sm-2 h2  bg-info bg-gradient"><a href="/static/contactus.html">CONTACT US</a></div>
            <h2 class="text-center bg-info">Home>>Contact Us Page</h2>
            <div class="h2 bg-warning" style="height:800px;">
                ...
                Telefax:</br>
                DG Office: +91-11-26781312, Email id: abcd@gmail.com</br>
                ADG Office: +91-11-26781341, Email id: adgofflice@gmail.com</br>
                Administration Directorate: +91-11-26781326, Email id: admin@gmail.com</br>
                Training Directorate: +91-11-26782027, Email id: jgiuq@gmail.com</br>
                NPM Directorate: +91-11-26781345, Email id: npm@gmail.comn</br>
                MOD Directorate: +91-11-26782023, Email id: hwgwdhgq@gmail.com</br>
                Research & CA Directorate: +91-11-26781314, Email id: befgwjh@gmsil.com</br>
                ------------------------------------------------------------------------</br>

                Phone:</br>
                Administration Directorate: 9154654768</br>
        ...
        <style>
            footer{
                font-size: 30px;
                text-align: center;
                background-color: rgb(14, 177, 96);
